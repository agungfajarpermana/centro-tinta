...
class BranchProductController extends Controller
{
    ...
    {
        return Branches::collection(BranchProduct::where('branch_id', 1)->orderBy('product_id', 'ASC')->paginate(8));
    }
    ...
    {
        $data = Product::where('branch_id', 1)->where('nama_product', 'LIKE', '%'.$search.'%')->paginate(2);
